...
const list = {
  prof: {
    pro: [
      'medical_v1', 'medical_v2', 'finance_v1', 'finance_v2', 'wood_v1', 'wood_v2',
    ],
  ...
  other: {
    pro: [
      'turizm_v1', 'turizm_v2', 'energo_v1', 'energo_v2', 'metal_v1', 'metal_v2',
    ],
    rgs: ['help_v1', 'help_v2'],
    dkk: ['companyBd'],
  },
...
const names = {
  ...
  turizm_v1: 'Новый год — Tуризм и гостеприимство (Вариант 1) &#11088; + анимация',
...
export { content, list, names, pictureUrl }
